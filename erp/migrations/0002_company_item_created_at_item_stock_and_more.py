    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inout', models.CharField(choices=[('in', 'input'), ('out', 'output')], default='input', max_length=50)),
            ],
        ),
        migrations.AddField(
            model_name='item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('company', models.ManyToManyField(related_name='company', to='erp.company')),
                ('item', models.ManyToManyField(related_name='order', to='erp.item')),
            ],
        ),
    ]
